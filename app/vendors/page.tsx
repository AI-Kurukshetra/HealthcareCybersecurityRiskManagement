...
export default async function VendorsPage() {
  ...
  const canCreateVendor = hasPermission(data.currentUser.profile.role, "create_vendor");
  const canEditVendor = hasPermission(data.currentUser.profile.role, "edit_vendor");
    ...
    >
      ...
      <section className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
        {canCreateVendor ? (
          ...
          <AccessNotice
            title="Vendor creation is limited to admins."
            description="Security analysts can still update vendor risk and compliance state, while viewer and staff accounts can review third-party posture without editing."
          />
        )}
